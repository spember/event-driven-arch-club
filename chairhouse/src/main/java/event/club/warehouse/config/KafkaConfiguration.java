...
import event.club.warehouse.services.messaging.Topics;
...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, String> producerFactory(@Value("${kafka.bootstrap}") final String bootstrapAddress) {
